import { RegisterRequest, RegisterResponse } from "@iot/contracts";
...
export class UserService {
    ...
    async register(request: RegisterRequest): Promise<RegisterResponse>{
        const exisitingUser = await this.userRepository.findByEmail(request.email);
        ...
        return this.transactionManager.execute(
            async(manager) => {
                ...
                user.email = request.email.trim().toLocaleLowerCase();
